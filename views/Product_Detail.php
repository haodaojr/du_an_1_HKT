            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="product-details bg-light p-4 rounded shadow">
                        ...
                        <h4 class="mb-3 product-price">Giá:
                            $<?= isset($SPCT['product_price']) ? htmlspecialchars($SPCT['product_price']) : 'Giá không có' ?>
                        </h4>
                        <div class="row g-3 mb-4">
                            <div class="col-auto d-flex align-items-center">
                                <button class="btn btn-outline-secondary" type="button" onclick="decreaseQuantity()">-</button>
                                <input type="text" class="form-control text-center mx-2" value="1" id="quantity" min="1" max="99">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" type="button">Add to Cart</button>
                            </div>
                        </div>
                ...
                foreach ($otherProducts as $Pro): ?>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="product-card">
                            <a href="?act=Pro_detail&product_id=<?= $Pro['product_id'] ?>" class="d-block product-item rounded">
